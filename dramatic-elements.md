1.	אתגר-
בשביל לשחק במשחק השחקן יצטרך להכיר את הארץ מבחינה בסיסית,
למשחק יהיו 3 רמות קושי שונות:
Tuturial: מקומות מוכרים וקלים לזיהוי במפה כמו החרמון, אילת, חיפה, ים המלח, הכנרת וים התיכון
1.	אזורים כלליים בארץ כמו רמת הגולן, הגליל העליון, הגליל התחתון, הכרמל, מישור החוף, שפלת יהודה, השומרון, הנגב, הערבה, מדבר יהודה.
2.	ערים גדולות כמו ירושלים, תל אביב, באר שבע, ראשון לציון, טבריה.
3.	ישובים, מושבים וקיבוצים- מקומות יותר קטנים ופחות מוכרים.
...
השחקן יוכל להשתמש במקשי החיצים על מנת להזיז את המטוס ימינה, שמאלה, למעלה ולמטה וכך השחקן יוכל לשלוח במשחק.
...
5.	רקע עלילתי-
הרקע העלילתי של המשחק הוא שהסיפור מתרחש בתקופה של מתיחות ביטחונית גבוהה, הארץ נמצאת בכוננות מוגברת, והשטח מלא במשימות דחופות. יחידות צה"ל הפזורות בשטח, זקוקות לאספקה מיידית, והשחקן שמייצג טייס של חיל האוויר צריך להנחית בשבילם את האספקה במקומות מסוימים.
